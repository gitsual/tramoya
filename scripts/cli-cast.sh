...
clear
ty "tramoya assemble --video take.mp4 --marks tests/fixtures/legacy-marks-v11.json --voice-dir voices/en --out demo.mp4 --dry-run | head -4"
tramoya assemble --video take.mp4 --marks tests/fixtures/legacy-marks-v11.json --voice-dir voices/en --out demo.mp4 --dry-run | head -4 | cut -c1-300; printf '\033[2m… 23 more ffmpeg calls, nothing encoded\033[0m\n'; sleep 3.5
